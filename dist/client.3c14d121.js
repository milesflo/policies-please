...
})({"hjWpJ":[function(require,module,exports,__globalThis) {
...
var _regorusjs = require("./regorus/bindings/wasm/pkg/regorusjs");
var _regorusjsDefault = parcelHelpers.interopDefault(_regorusjs);
...
policyWindow.onkeydown = function(e) {
    if (e.keyCode === 9) {
        e.preventDefault(); // Prevent the default tab behavior (focusing next element)
...
evaluateButton.addEventListener("click", function() {
    ...
    let engine = new (0, _regorusjs.Engine)();
    try {
...
async function evaluateRego() {
    await (0, _regorusjsDefault.default)();
...
},{"./regorus/bindings/wasm/pkg/regorusjs":"5ISCH","@parcel/transformer-js/src/esmodule-helpers.js":"bYT6T"}],"5ISCH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') module_or_path = new URL(require("9b30c691c4fd14ad"));
    const imports = __wbg_get_imports();
...
},{"9b30c691c4fd14ad":"6LGjV","@parcel/transformer-js/src/esmodule-helpers.js":"bYT6T"}],"6LGjV":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("regorusjs_bg.8afcc66e.wasm") + "?" + Date.now();

},{}],"bYT6T":[function(require,module,exports,__globalThis) {
...
},{}]},["hjWpJ","kTBnD"], "kTBnD", "parcelRequire94c2", {}, "./", "/")

//# sourceMappingURL=client.3c14d121.js.map
